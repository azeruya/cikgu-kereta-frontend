            ...
            <tr v-for="job in filteredJobs" :key="job.id">
              ...
              <td>
                <div class="action-group">
                  <button class="btn btn-sm btn-ghost" @click="openDetail(job)">View</button>
                  <button class="btn btn-sm btn-ghost" @click="openWhatsApp(job)">WhatsApp</button>
      ...
      <div class="modal" v-if="activeJob" @click.self="activeJob = null">
        <div class="modal-card large">
          ...
          <div class="modal-actions">
            ...
            <button class="btn-primary" @click="markPaid(activeJob.id)">
              Add Payment
            </button>
          </div>
        </div>
